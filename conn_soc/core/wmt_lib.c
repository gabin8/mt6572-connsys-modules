...
static MTK_WCN_BOOL wmt_lib_ps_do_host_awake(VOID)
{
	 ...
	 * exchange. The downstream default remaps this to the WAKEUP flow
	 * (WAK pulse), but on mt6572 fw 0x1319 that wedges the radio on the
	 * first inbound event while the host sleeps. */
