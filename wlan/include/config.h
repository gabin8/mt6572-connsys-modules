...
/* ALPS MT65x2 sends the start command with no override (fw derives its own
 * entry); the BPI value 1 is an MT7623-ism that leaves the ready bit unset */
#define CFG_OVERRIDE_FW_START_ADDRESS           0
...
#define CFG_SUPPORT_HOTSPOT_OPTIMIZATION                CFG_ENABLE_WIFI_DIRECT
...
#define CFG_SUPPORT_WFD                     CFG_ENABLE_WIFI_DIRECT

#define CFG_SUPPORT_WFD_COMPOSE_IE          CFG_SUPPORT_WFD
